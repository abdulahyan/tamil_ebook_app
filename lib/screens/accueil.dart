...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  Widget menu(context) {
    var itemStyle = TextStyle(color: Theme.of(context).primaryColor, fontSize: 13);
          ...
          child: Align(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                TextButton(
                    onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => EditProfilePage())),
                    child: Text(
                      "Your Email",
                      style: itemStyle,
                    )),
                        ...
                        children: <Widget>[
                          InkWell(
                            child: Column(
                              ...
                              children: <Widget>[
                                Padding(
                                  padding: EdgeInsets.only(bottom: sizeH * 0.005),
                                  child: !(isSelected == 0)
                                      ? SvgPicture.asset(
