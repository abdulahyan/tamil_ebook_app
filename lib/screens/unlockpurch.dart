...
class _UnlockPurchasedPageState extends State<UnlockPurchasedPage> {
        ...
        children: <Widget>[
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(
                            fontSize: 13,
                            color: selectedPlan == 1 ? Theme.of(context).primaryColor : Theme.of(context).accentColor),
                      ),
                    ),
                  ),
                ),
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: selectedPlan == 2 ? Theme.of(context).primaryColor : Theme.of(context).accentColor,
                          fontSize: 13,
                        ),
                      ),
                    ),
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: selectedPlan == 3 ? Theme.of(context).primaryColor : Theme.of(context).accentColor,
                          fontSize: 13,
                        ),
                      ),
                    ),
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Text(
                  selectedPlan == 1 ? "7 Days Free Trial" : selectedPlan == 2 ? "Monthly Access" : "Yearly Access",
                ...
                Text(
                  selectedPlan == 1
                      ...
                      : selectedPlan == 2 ? "\$19.99/6 MO After Trial" : "\$9.99/6 MO After Trial",
                ...
                SizedBox(
                  ...
                  child: TextButton(
                    ...
                    child: Text(
                      "Done",
                      style:
                          TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Theme.of(context).primaryColor),
                    ),
                  ),
                ),
              ],
          ...
          Align(
            ...
            child: TextButton(
              style: ButtonStyle(
                padding: MaterialStateProperty.all(EdgeInsets.fromLTRB(sizeW * 0.4, sizeH * 0.02, sizeW * 0.4, sizeH * 0.02)),
                shape: MaterialStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(12.0)))),
                foregroundColor: MaterialStateProperty.all(Theme.of(context).accentColor)
              ),
              //padding: EdgeInsets.fromLTRB(sizeW * 0.4, sizeH * 0.02, sizeW * 0.4, sizeH * 0.02),
  ...
  appBar() {
    return Container(
      ...
      height: sizeH * 0.12,
      decoration: BoxDecoration(
          color: Theme.of(context).accentColor, borderRadius: BorderRadius.only(bottomLeft: Radius.circular(16))),
      child: Padding(
        padding: EdgeInsets.only(top: sizeW * 0.06, right: sizeW * 0.04, left: sizeW * 0.04),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: <Widget>[
            InkWell(
