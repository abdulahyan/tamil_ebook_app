...
class _LiteratureState extends State<Literature> with SingleTickerProviderStateMixin {
  var sizeW;
  var sizeH;
  Book _book;
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: TabBar(
              ...
              indicator: UnderlineTabIndicator(borderSide: BorderSide(width: 2, color: Theme.of(context).accentColor)),
              tabs: <Widget>[
                Tab(
                  text: 'Chapters',
                ),
      ...
      child: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    CircleAvatar(
                      ...
                      backgroundImage: AssetImage(comments[index].profile_picture_commenter),
                      maxRadius: 21.6,
                    ),
                    SizedBox(
                      width: 14.4,
                ...
                Align(
                    ...
                    child: InkWell(
                      child: Icon(
                        comments[index].isliked ? Icons.favorite : Icons.favorite_border,
                        size: 14.4,
                        color: Colors.red,
                      ),
                      onTap: () {
                        setState(() {
                          comments[index].isliked ? comments[index].isliked = false : comments[index].isliked = true;
                        });
                      },
                    ))
              ],
            ...
            Padding(
              padding: EdgeInsets.only(top: sizeW * 0.04, left: sizeW * 0.14, bottom: sizeW * 0.04),
              child: Text(
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(image: AssetImage(_book.image), fit: BoxFit.cover),
              ...
              children: <Widget>[
                ...
                SizedBox(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (_) => BookListen(_book)));
                    },
                  ),
                )
              ],
            ...
            children: <Widget>[
              ...
              Expanded(
                ...
                child: Icon(
                  ...
                  size: 18,
                  color: chapters[index].islocked ? Theme.of(context).accentColor : null,
                ),
              )
            ],
          ),
