...
class _ProfileTabState extends State<ProfileTab> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Column(
          children: <Widget>[TopBarWidget(title: "Profile"), profileHead(), profletabs()],
        ));
  }
            ...
            children: <Widget>[
              Container(
                  ...
                  decoration: new BoxDecoration(
                      ...
                      image: new DecorationImage(image: new AssetImage(user.image), fit: BoxFit.cover)),
                  child: new Center(
                      child: ClipRRect(
                            ...
                            child: new Center(
                              child: new Text(
                                ...
                                style: Theme.of(context)
                                    .textTheme
                                    .headline1
                                    .merge(prefix0.TextStyle(color: Theme.of(context).primaryColor, fontWeight: FontWeight.w300)),
                              ),
                            ),
                          ),
                        )),
        ...
        Container(
          child: Align(
            ...
            child: Container(
              ...
              height: 110,
              decoration: BoxDecoration(
                  image: DecorationImage(image: AssetImage("assets/user1.jpg"), fit: BoxFit.cover),
    ...
    return Padding(
      ...
      child: GridView.builder(
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              crossAxisCount: num, mainAxisSpacing: 20, childAspectRatio: 0.75, crossAxisSpacing: 20),
