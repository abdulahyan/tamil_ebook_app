                        ...
                        children: <Widget>[
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(image: AssetImage(_books[ind].image), fit: BoxFit.cover)),
                          ),
                          Padding(
                    ...
                    Container(
                      child: InkWell(
                        child: CircleAvatar(
                          ...
                          child: Icon(
                            _books[ind].listened == true ? Icons.play_arrow : Icons.subject,
                            color: Theme.of(context).primaryColor,
                            size: 28.8,
                          ),
                        ),
