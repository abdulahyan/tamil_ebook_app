                  ...
                  children: <Widget>[
                    Container(
                        ...
                        decoration: new BoxDecoration(
                          borderRadius: BorderRadius.only(bottomLeft: Radius.circular(sizeW * 0.1)),
                          image: new DecorationImage(image: new AssetImage(playing_book.image), fit: BoxFit.cover),
                        ),
                        child: new Center(
                            child: ClipRRect(
                          borderRadius: BorderRadius.only(bottomLeft: Radius.circular(sizeW * 0.1)),
                              ...
                              child: new SizedBox(
                                ...
                                child: BackdropFilter(
                                  ...
                                  child: new Center(
                                    child: Column(
                                      children: <Widget>[
                                        TopBarWidget(title: 'Now Playing', hasBackButton: true, transparent: true),
                                        Container(
                                          width: 120,
                                          height: 165,
                                          decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                  image: AssetImage(playing_book.image), fit: BoxFit.cover)),
                                        ),
                                        SizedBox(
                                          height: 15,
                                        ),
                                        Align(
                                          ...
                                          child: Padding(
                                            padding: EdgeInsets.only(left: sizeW * 0.1),
                                            child: Text(
                                              playing_book.title,
                    ...
                    Container(
                      child: Padding(
                        ...
                        child: CircleAvatar(
                          ...
                          child: InkWell(
                            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => PlayerPage(this.playing_book))),
                            child: Icon(
                            Icons.play_arrow,
                                ...
                                child: BackdropFilter(
                                  ...
                                  child: new Center(
                                    child: Column(
                                      children: <Widget>[
                                        Padding(
                                          padding: EdgeInsets.only(top: 36, right: sizeW * 0.04, left: sizeW * 0.04),
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: <Widget>[
                                              InkWell(
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              playing_book.title,
                                              style: TextStyle(
                                                  fontSize: 21.6, fontWeight: FontWeight.bold, color: Colors.white),
                                            ),
                                          ),
                                        ),
                                        SizedBox(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Column(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Text(
                                                    playing_book.author + " I dont know ",
                                                    style: TextStyle(fontSize: 12, color: Colors.white),
                                                  )
                                                ],
                                              ),
